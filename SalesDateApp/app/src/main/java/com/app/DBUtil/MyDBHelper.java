...
public class MyDBHelper extends DataBaseHelper {
    ...
    protected String[] getDbCreateSql(Context context) {
        ...
        a[1] = "CREATE TABLE food (id INTEGER PRIMARY KEY AUTOINCREMENT,userid VARCHAR(50),dbfoodname VARCHAR(50), classification VARCHAR(50), time VARCHAR(50), imagepath VARCHAR(200))";
        //add period & date
